...
export function parts() {
  ...
  push(part('box', [0, 6.5, -2], [0.5, 0.5, 32], 'hullTrim'));
  ...
  push(part('cyl', [0, 7.4, -6], [0.2, 2.2, 0.2], 'hullTrim'));               // aerials
  push(part('cyl', [0, 7.4, 6], [0.2, 2.2, 0.2], 'hullTrim'));
