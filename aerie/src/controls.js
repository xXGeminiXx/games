...
export function isOurs(e) {
  ...
  // Escape is the one key a text box does not get to keep: it is what a
  // player presses to get out of whatever they opened.
  if (String(e.key || '').toLowerCase() === 'escape') return true;
  const t = e.target;
