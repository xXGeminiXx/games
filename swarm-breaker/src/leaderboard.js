...
import { identity as deviceIdentity, verify as verifySignature } from './identity.js?v=24';
import { canonicalRun, canonicalWitness, logHash as logHashOf, entryState, STATE } from './verify.js?v=24';
