...
export const CONFIG = {
  ...
  text: {
    ...
    beyond:      'Zoom out',
    fruit:       'Send up mushrooms',
    fruitSure:   'Sure? This fungus ends',
    shareAuto:    'Minerals follow the best price',
    shareAutoTip: 'The trees paying most get the minerals, and it keeps up with the seasons on its own',
    ...
    instinct: {
      names: { extend: 'Open rings', tips: 'Grow tips', beyond: 'Zoom out' },
      hints: {
        ...
        beyond: 'Move up to the bigger map on its own once a map is finished. Off until you switch it on',
      },
      acted:  { extend: 'opened a ring', tips: 'grew the front', beyond: 'zoomed out' },
      on:     'on',
      off:    'off',
      ago:    '{what}, {t} ago',
    ...
    panels: {
      ...
      instinct: 'Habits',
      spores:  'Mushrooms',
      genome:  'Kept by every fungus after',
    },
