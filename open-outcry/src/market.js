...
import { OrderBook, BUY, SELL } from './orderbook.js?v=5';
import * as I from './market-inspect.js?v=5';
import { DEFAULT_RULES, SHOCKS } from './market-rules.js?v=5';
import { F64, I32, U8, save, load } from './market-save.js?v=5';
