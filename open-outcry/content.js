...
export const CONTENT = {
  ...
  labels: {
    ...
    push: 'Push',
    flatten: 'Flatten',
    flattenHint: 'Sell what you are carrying into the bid, now, at whatever it pays.',
    owned: 'you have {n}',
    ...
    cityNeed: 'Corner a pit first. The next city wants a name.',
    ...
    copied: 'Copied.',
    importBad: 'That is not a run: {why}',
    fold: 'Hide the panel',
  ...
  pits: {
    ...
    salt:   'A salt trader holds an opinion for a long time. News takes a while to be believed, and a fast reader is paid for it.',
    timber: 'Everybody writes the same ticket here, so the book is blocky and one order moves it further than you expect.',
    iron:   'Iron trends. A print above where they thought it was is read as a reason to expect another, and it runs.',
    cloth:  'Cloth sits still and then corrects hard. The size arrives with the conviction, and it crosses the spread to get done.',
  ...
  clerkCards: {
    ...
    firstWhy: 'A clerk who requotes when the mid has moved away from you. The first one is the last time you have to click Requote.',
  },
  ...
  intro: {
    title: 'The pit',
    body: 'Write a bid on the left and an offer on the right, with a size beneath them. The crowd trades against your quotes. You keep the difference when both sides fill, and you pay for it when the price leaves you standing on one.',
    go: 'Take the rail',
  },
};
