...
export const CONTENT = {
  ...
  labels: {
    ...
    owing: 'You owe {n} sacks you have already sold.',
    owingLots: "You owe {n} sacks you have already sold. That's a lot to owe if the price climbs.",
    crowd: '{n} people here today',
    buyers: 'buyers',
    sellers: 'sellers',
    ...
    marketCost: 'costs {n}',
    marketsFull: 'You have room for {n} markets in this town. Buy one up to make room.',
    ...
    copied: 'Copied.',
    importBad: "That's not a game: {why}",
    fold: 'Hide this',
    ...
    awayHolding: 'You came back holding {n} sacks.',
    awayOwing: 'You came back owing {n} sacks.',
    ...
    nextNone: 'Keep your board on the price and the purse fills.',
  },
  ...
  events: {
    ...
    wiped: 'you wrote pay {bid} and charge {ask}',
    ...
    marketCornered: 'you bought up the {pit} market. It paid {funds}, and your name is worth {rep} more.',
    ...
    citySpent: 'you spent {n} on {label}',
  },
  ...
  rumours: {
    ...
    drought: { news: 'the crop has failed where the {pit} comes from', land: 'the failed crop bites. There is hardly any {pit}', dir: 'up' },
  ...
  actions: {
    ...
    lean: 'push both prices up or down together',
  ...
  clerkCards: {
    ...
    firstWhy: "Writes your board again the moment the price walks off it, so a market you aren't standing at keeps trading.",
  },
