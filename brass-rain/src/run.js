...
import { createBoard, pocket } from './board.js?v=17';
import { createBalls, launch, clearBalls, stepPhysics } from './physics.js?v=17';
import { fire, hasHook } from './hooks.js?v=17';
import {
