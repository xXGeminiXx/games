...
import { createBoard, pocket } from './board.js?v=32';
import { createBalls, launch, clearBalls, stepPhysics } from './physics.js?v=32';
import { fire, hasHook } from './hooks.js?v=32';
import {
