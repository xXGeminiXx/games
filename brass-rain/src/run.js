...
import { createBoard, pocket } from './board.js?v=39';
import { createBalls, launch, clearBalls, stepPhysics } from './physics.js?v=39';
import { fire, hasHook } from './hooks.js?v=39';
import {
