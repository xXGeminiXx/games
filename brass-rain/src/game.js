...
import { loadConfig } from '../config.js?v=66';
import { createRun, stepRun, createOut, startRound, pullHandle, quotaFor, quotaRate,
         ...
         PHASE_PLAY, PHASE_SETTLE, PHASE_SHOP, PHASE_OVER } from './run.js?v=66';
import { createFloor, tickFloor, cashOut, buyMachine, hireAttendant, quote,
         ...
         handMult, restoreFloor } from './floor.js?v=66';
import { createQuality, observe, renderQuality, resetMeasurement, restoreQuality } from './quality.js?v=66';
import { createBench, buildMods, partnersFor, fire as fireHook, hasHook } from './hooks.js?v=66';
import { fitMachine, buildFittedBoard, runConfig } from './parts.js?v=66';
import { nailNear, bendNail, bendCheck, straighten, nailPos } from './board.js?v=66';
import { rng as makeRng } from './rng.js?v=66';
import { offerCabinets, freshSeed } from './cabinets.js?v=66';
import * as Save from './save.js?v=66';
import { showState } from './render/reach.js?v=66';
import { skinForCabinet } from './render/themes.js?v=66';
import { chooseDoor as callDoor } from './events.js?v=66';
...
export async function createGame(opts) {
  ...
  const catalogue = await optional('./fittings.js?v=66');
  const metaModule = await optional('./meta.js?v=66');
