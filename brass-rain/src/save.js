...
import { serializeBends, restoreBends } from './board.js?v=8';
import { serializeBalls, restoreBalls } from './physics.js?v=8';
import { serializeFloor, restoreFloor } from './floor.js?v=8';
import { serializeQuality } from './quality.js?v=8';
