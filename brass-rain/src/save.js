...
import { serializeBends, restoreBends } from './board.js?v=26';
import { serializeBalls, restoreBalls } from './physics.js?v=26';
import { serializeFloor, restoreFloor } from './floor.js?v=26';
import { serializeQuality } from './quality.js?v=26';
