...
// market, the rites - and each arrival is announced by one line in the log.
// ---------------------------------------------------------------------------

import { BONES } from './materials.js?v=1';

/** Flag -> the log line that announces it (a key into CONFIG.text.log). */
