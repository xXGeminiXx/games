...
import { storageKey, fill } from '../config.js?v=19';
import { createSim, restoreSim, openedState } from './sim.js?v=19';
...
import { fmtTime, fmt, fmtCoin, fmtCount } from './numbers.js?v=19';
