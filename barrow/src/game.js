...
import { storageKey, fill } from '../config.js?v=27';
import { createSim, restoreSim, openedState } from './sim.js?v=27';
...
import { createView } from './view.js?v=27';
import { fmtTime, fmt, fmtCoin, fmtCount } from './numbers.js?v=27';
