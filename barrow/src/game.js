...
import { storageKey, fill } from '../config.js?v=28';
import { createSim, restoreSim, openedState } from './sim.js?v=28';
...
import { createView } from './view.js?v=28';
import { fmtTime, fmt, fmtCoin, fmtCount } from './numbers.js?v=28';
