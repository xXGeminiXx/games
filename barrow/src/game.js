...
import { storageKey, fill } from '../config.js?v=34';
import { createSim, restoreSim, openedState } from './sim.js?v=34';
...
import { createView } from './view.js?v=34';
import { fmtTime, fmt, fmtCoin, fmtCount } from './numbers.js?v=34';
