...
import { storageKey, fill } from '../config.js?v=18';
import { createSim, restoreSim, openedState } from './sim.js?v=18';
...
import { fmtTime, fmt, fmtCoin, fmtCount } from './numbers.js?v=18';
