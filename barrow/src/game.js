...
import { storageKey, fill } from '../config.js?v=23';
import { createSim, restoreSim, openedState } from './sim.js?v=23';
...
import { createView } from './view.js?v=23';
import { fmtTime, fmt, fmtCoin, fmtCount } from './numbers.js?v=23';
