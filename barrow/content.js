...
export const CONTENT = {
  ...
  seams: {
    ...
    bonefield:{ tag: 'bonefield', line: '3.2x the bones, worth 0.7x' },
    thin:     { tag: 'thin',      line: 'worth 1.8x, but its market takes 0.4x' },
    wide:     { tag: 'wide',      line: 'its market takes 2.8x more' },
    ...
    sealed:   { tag: 'sealed',    line: 'worth 1.7x, behind a floor 2.6x as thick' },
