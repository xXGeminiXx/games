...
export const CONTENT = {
  ...
  visitors: {
    ...
    preacher: {
      ...
      offer: 'Pay him and the crew finds {x}x the bones for {t}.',
      take: 'Pay him',
      pass: 'Not today',
    ...
    tinker: {
      name: 'A tinker',
      lines: [
        'A tinker with a grindstone on his back asks if your spades need an edge.',
      ...
      offer: 'Pay him and the crew digs {x}x as fast for {t}.',
      take: 'Pay him',
      pass: 'Not today',
      taken: 'He works down the line with his grindstone. The crew digs {x}x as fast for {t}.',
      passed: 'He hitches up his grindstone and walks on.',
    ...
    cups: {
      ...
      offer: 'Find the pea and he pays you {x}x your bet. Miss and he keeps it.',
      take: 'Bet',
      pass: 'Walk away',
    ...
    herald: {
      ...
      offer: 'Pay him and your crew breaks {lord}\'s door {pct}% faster.',
      take: 'Pay him',
      pass: 'Send him back',
